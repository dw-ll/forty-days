  ...
  return (
    <div class={noteStyle.container}>
      ...
      <div class="relative py-4 ">
        <input type="search" class="text-grey-900 shadow-md rounded border border-grey-light p-3 w-full sm:w-1/2 lg:w-1/4 hover:shadow-lg focus:shadow-lg" placeholder="Search" onChange={searchChangeHandler} >
        </input>
      </div>
